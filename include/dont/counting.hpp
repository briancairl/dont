...
template <typename IntT, size_t N, size_t I = 0,
          typename Prev = IntegerSequence<IntT>>
...
template <typename IntT, size_t N, IntT... Is>
struct MakeIntegerSequence<IntT, N, N, IntegerSequence<IntT, Is...>> {
...
template <typename IntT, size_t N, size_t I = 0>
struct MakeIntegerSequence : detail::MakeIntegerSequence<IntT, N, I> {};

template <typename IntT, size_t N>
using make_integer_sequence_t = typename MakeIntegerSequence<IntT, N, 0>::type;

template <size_t N>
using make_index_sequence_t = typename MakeIntegerSequence<size_t, N, 0>::type;
